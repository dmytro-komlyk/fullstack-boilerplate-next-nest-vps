...
export default async function Home({ params: { locale } }: Props) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-slate-200 dark:bg-slate-700">
      ...
      <div className="mb-32 grid gap-3 text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left z-10">
        <a
          href="https://nextjs.org/docs?utm_source=create-next-app&utm_medium=appdir-template&utm_campaign=create-next-app"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors text-slate-700 dark:text-slate-50 hover:text-black hover:border-gray-300 hover:bg-gray-100 hover:dark:text-white hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
          rel="noopener noreferrer"
        >
