        ...
        <Form className="p-4 md:p-5 lg:p-6" onSubmit={props.handleSubmit}>
          <div className="grid gap-y-3">
            <Button
              ...
              className="flex items-center justify-center gap-x-2 rounded-md border border-slate-600 bg-slate-700 px-4 py-3 text-slate-300 transition hover:text-purple-400"
            >
              <svg
              ...
              {({ meta, field }: any) => (
                <Input
                  ...
                  endContent={
                    ...
                    >
                      {isVisiblePassword ? (
                        <AiFillEyeInvisible className="text-xl text-slate-400 hover:text-slate-200" />
                      ) : (
                        <AiFillEye className="text-xl text-slate-400 hover:text-slate-200" />
                      )}
                    </button>
                  }
                  {...field}
